...
const AVAILABLE_LANGS = [
    ...
    },
    {
        ...
        translate: {
            ...
            <p></p>
            <blockquote>
                <p><strong>Важно!</strong> Приложение не взаимодействует с сервером, а это значит, что никакая информация не передаётся по сети.</p>
                <p>Приложение работает с данными путём конвертирования их в <a href="https://en.wikipedia.org/wiki/Base64">Base64</a>&nbsp;и указания их в качестве параметра запроса.</p>
                <p>Это значит, что любая отправленная вами ссылка с чек-листом содержит эти данные практически в открытом виде. Поэтому, не добавляйте в чек-листы пароли и любую другую информацию, компрометации которой вы не хотите.</p>
            </blockquote>
            `,
